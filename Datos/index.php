...
$app->get('/traerPersonas[/]', function ($request, $response, $args) {
...
$app->post('/intertarPersona[/]', function($request, $response, $args){
	$datospost=$request->getParsedBody();
	// $unaPersona= Persona::InsertarPersona($datospost);
